...
- open: claude-codexfix-1 (claude) - codex notify + rollout fix, joins PR #8
- open: antigravity-panelwire-1 (agy lane 1) - panel transcript view, branch harnet/antigravity
- open: antigravity-docs-2 (agy lane 2) - API docs refresh, branch harnet/antigravity-2
...
- antigravity: lane 1 busy (panelwire-1), lane 2 busy (docs-2)
- chatgpt: idle, quota spared
- claude: busy (codexfix-1, joins PR #8)
